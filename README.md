...
| Ситуация | Поведение |
|---|---|
| Центр уходит к краю холста | cx зажат в `[bboxHalfX, WIDTH − bboxHalfX]`, где `bboxHalfX = sqrt(a²cos²θ + b²sin²θ)` — эллипс всегда полностью виден |
| Апекс уходит выше/ниже керна | apexY зажат в [coreTop+2, coreBottom−2] |
| Апекс уходит за правую границу керна | apexX зажат в [cx + b + 10, WIDTH] |
